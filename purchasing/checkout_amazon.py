...
(your-agent-email@gmail.com) with gift card balance as the payment method.
...
Key differences from RotorVillage:
  ...
  - Shipping: Amazon uses its own address book — address must be saved to
    the your-amazon-account account before automation runs.
            ...
            if order_total > balance_card["remaining"]:
                return {
                    ...
                    "message": (
                        ...
                        f"Add more funds to the your-amazon-account Amazon account."
                    ),
                    "order_id": None,
                }
