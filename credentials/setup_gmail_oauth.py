...
Run this once on shinobi to authorize Q2's Gmail account.
...
print("Starting Gmail OAuth setup for iamkewtoo@gmail.com...")
print("A browser window will open — sign in as iamkewtoo@gmail.com and grant access.")
print()
